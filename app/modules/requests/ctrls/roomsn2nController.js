        ...
        $scope.insertRoom = function () {
            ...
            if ($scope.ctrl.state === 0) {
                ...
                api.apiCall(method, 'api/public/requests/rooms/' + $scope.ctrl.pivotData.id, function (results) {
                    ...
                    for (var i = 0; i < $scope.ctrl.ldp.length; i++) {
                        if ($scope.ctrl.ldp[i].pivot['fromt']) {
                            $scope.ctrl.ldp[i].pivot['fromt'] = new Date('1970-01-01 ' + $scope.ctrl.ldp[i].pivot['fromt']);
                            $scope.ctrl.ldp[i].pivot['tot'] = new Date('1970-01-01 ' + $scope.ctrl.ldp[i].pivot['tot']);
                        }
                    }
