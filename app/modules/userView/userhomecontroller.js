...
angular.module('Users')
    .controller('UserViewTableController', ['$scope', '$location', 'api', '$uibModal', 'MakeModal', '$translate', 'orderByFilter', function ($scope, $location, api, $uibModal, MakeModal, $translate, orderBy) {
        ...
        $scope.propertyName = 'req_dt';
        $scope.reverse = true;
        $scope.sortBy = function (propertyName, dp) {
            $scope.reverse = (propertyName !== null && $scope.propertyName === propertyName)
                ? !$scope.reverse : false;
            $scope.propertyName = propertyName;
            $scope.dp = orderBy(dp, $scope.propertyName, $scope.reverse);
        };
    ...
    .controller('UserViewController', ['$scope', 'globalVarsSrv', 'ClrStatusSrv', 'api', '$routeParams', '$location', 'AuthenticationService', 'MakeModal',
        function ($scope, globalVarsSrv, ClrStatusSrv, api, $routeParams, $location, AuthenticationService, MakeModal) {
            ...
            $scope.acceptReq = function (item, confirmType) {
