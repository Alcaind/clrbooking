...
class Tm extends Model
{
    ...
    {
        return $this->belongsToMany('\\App\\Models\\Users', 'tm_users', 'tm_id', 'user_id')->withPivot('comments');
    }
    ...
    public function defaulttm()
    {
        return $this->belongsTo("\\App\\Models\\Tm", 'default_tm_sel');
    }
